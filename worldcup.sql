...
--
-- Name: games id_connect; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT id_connect FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);


--
-- Name: games opponent_id_connect; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT opponent_id_connect FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
